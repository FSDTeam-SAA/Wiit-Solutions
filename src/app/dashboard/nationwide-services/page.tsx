...
export default function EditableContentForm() {
    ...
    const handleSubtitleChange = (index: number, e: ChangeEvent<HTMLInputElement>) => {
    ...
    const handleCustomIconChange = (index: number, e: ChangeEvent<HTMLInputElement>) => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        console.log("Form submitted with data:", {
            ...
            customIcons: formData.customIcons.map((file) => (file ? file.name : null)),
                                    ...
                                    {formData.customIconPreviews[index] ? (
                                        <div className="mt-2 p-2 border rounded flex justify-center items-center">
                                            <div className="flex items-center justify-center h-10 w-10 bg-muted rounded-md">
                                                <Image
                                                    src={formData.customIconPreviews[index] || "/placeholder.svg"}
                                                    alt="Custom icon"
