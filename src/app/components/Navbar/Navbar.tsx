                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center sm:hidden">
                        <button type="button" className="text-white hover:text-gray-300 focus:outline-none" onClick={toggleMenu}>
                            ...
                            {isMenuOpen ? (
                                ...
                                <Menu  className="block h-[50px] w-[50px]" aria-hidden="true" />
                            )}
                        </button>
                    </div>
                        ...
                        <div className="flex  items-center gap-10">
                            ...
                            <div className="hidden sm:block flex-1">
                                <div className="flex justify-center space-x-8">
                                    ...
                                    <Link href="/services" className="text-white hover:text-gray-300 px-3 py-2 text-sm font-medium">
                                        Nationwide Services
                                    </Link>
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0">
                            <Image src={logo} alt="WIIT Logo" width={100} height={100} className="h-[100px] w-[100px]" />
                        </div>
                    </div>
                </div>
            </div>
